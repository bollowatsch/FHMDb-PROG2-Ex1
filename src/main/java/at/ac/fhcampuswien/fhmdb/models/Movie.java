...
public class Movie {
    ...
    public static List<Movie> initializeMovies(){
        ...
        movies.add(new Movie("12th fail",
                ...
                new ArrayList<>(Arrays.asList(Genre.DRAMA, Genre.BIOGRAPHY))));
        movies.add(new Movie("The Dark Knight",
                "When the menace known as the Joker wreaks havoc and chaos on the people of Gotham, Batman must accept one of the greatest psychological and physical tests of his ability to fight injustice.",
                new ArrayList<>(Arrays.asList(Genre.DRAMA, Genre.CRIME, Genre.ACTION))));
        movies.add(new Movie("Schindler's List",
                "In German-occupied Poland during World War II, industrialist Oskar Schindler gradually becomes concerned for his Jewish workforce after witnessing their persecution by the Nazis.",
                new ArrayList<>(Arrays.asList(Genre.DRAMA, Genre.HISTORY, Genre.BIOGRAPHY))));
        ...
        movies.add(new Movie("Inception",
                ...
                new ArrayList<>(Arrays.asList(Genre.ACTION, Genre.ADVENTURE, Genre.SCIENCE_FICTION))));
        ...
        movies.add(new Movie("Forrest Gump",
                ...
                new ArrayList<>(Arrays.asList(Genre.DRAMA, Genre.ROMANCE))));
        ...
        movies.add(new Movie("The Good, the Bad and the Ugly",
                ...
                new ArrayList<>(Arrays.asList(Genre.ADVENTURE, Genre.WESTERN))));
        return movies;
    }
}
